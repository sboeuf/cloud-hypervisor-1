...
const METADATA_LENGTH_MAX: u32 = 1024 * 1024; // 1 MiB
...
pub enum VhdxMetadataError {
    ...
    ReservedIsNonZero,
    #[error("This implementation support this metadata flag")]
    UnsupportedFlag,
}
...
impl DiskSpec {
    /// Parse all meatadata from the provided file and store info in DiskSpec structure
